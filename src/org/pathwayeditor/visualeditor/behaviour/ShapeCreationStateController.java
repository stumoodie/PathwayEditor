...
public class ShapeCreationStateController implements IMouseStateBehaviourController {
	...
	public ShapeCreationStateController(IShapePane pane, IOperationFactory opFactory){
		this.shapePane = pane;
