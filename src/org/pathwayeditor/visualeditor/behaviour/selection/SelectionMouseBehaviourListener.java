...
//					currDragResponse = (ISelectionDragResponse)this.mouseBehaviourController.getDragResponse(SelectionHandleType.None);
...
//					currDragResponse.setSelectionHandle(currSelectionHandle);
