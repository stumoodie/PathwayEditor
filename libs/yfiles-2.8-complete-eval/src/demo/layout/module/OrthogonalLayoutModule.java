...
public class OrthogonalLayoutModule extends LayoutModule
{
  ...
  public OptionHandler createOptionHandler()
  {
    ...
    ConstraintManager.Condition c = cm.createConditionValueEquals(USE_EXISTING_DRAWING_AS_SKETCH, Boolean.FALSE);
    cm.setEnabledOnCondition(c, op.getItem(CROSSING_POSTPROCESSING));
    cm.setEnabledOnCondition(c, op.getItem(PERCEIVED_BENDS_POSTPROCESSING));
    cm.setEnabledOnCondition(c, op.getItem(STYLE));
    cm.setEnabledOnCondition(c, op.getItem(USE_RANDOMIZATION));
