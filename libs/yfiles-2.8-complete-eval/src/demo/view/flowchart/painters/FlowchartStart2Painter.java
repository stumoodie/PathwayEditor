...
/**
* This class is an implementation of {@link y.view.GenericNodeRealizer.Painter} that draws the "start2" symbol of flowchart diagrams.
 **/
public class FlowchartStart2Painter extends AbstractFlowchartPainter{
  public FlowchartStart2Painter() {
    super();
