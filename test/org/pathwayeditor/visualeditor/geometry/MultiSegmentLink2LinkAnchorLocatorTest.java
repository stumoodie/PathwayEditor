...
@RunWith(JMock.class)
public class MultiSegmentLink2LinkAnchorLocatorTest {
	...
	public void setUp(){
		...
		this.expectedSuggestedAnchorPoint = new Point(3.125, 0.0);
		final ILinkPointDefinition mockLinkDefn = this.mockery.mock(ILinkPointDefinition.class, "mockLinkDefn");
		mockery.checking(new Expectations(){{
			allowing(mockLinkDefn).drawnLineSegIterator(); will(returnIterator(new LineSegment(new Point(4.0, 3.0), new Point(6.0, 5.0)),
					new LineSegment(Point.ORIGIN, new Point(4.0, 3.0))));
		}});
